...
const plans = {
  "paris-normandie": [
    ...
    ["7 aug", "Val på plats: strand + Houlgate nattmarknad", "Houlgate, Villers eller Cabourg efter väder. Fredag kväll: nattmarknad i Houlgate, info kommer via e-post. Boka taxi eller annan hemtransport till Deauville när tid och plats är bekräftade."],
